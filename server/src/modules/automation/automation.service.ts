...
import { buildArticleCreateData, type CreateArticleInput } from '../articles/article.mapper.js'
...
export async function createAutomationArticlesBatch(inputs: CreateArticleInput[]) {
  const results = []
